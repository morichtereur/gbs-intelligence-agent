...
ALLOWED_TAGS = [
    t.strip()
    for t in os.getenv("INTEL_ALLOWED_TAGS", "Finance_Strategy,Operating_Model,GBS,GCC,Process_Excellence,Controlling_FPA,Agentic_AI,Client_Signal,Analyst_Research").split(",")
    if t.strip()
]
